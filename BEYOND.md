...
inside the "makeGuess()" function, instead of just saying "Correct", it judges how well you did. Guessing it in 1 or 2 tries gives an "Amazing!" message, while taking a bunch of tries gives a different response.